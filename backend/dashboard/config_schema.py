...
CONFIG_SCHEMA = [
    ConfigSection(
        ...
        description=(
            "Comptes de connexion (frontend + dashboard). Tant que "
            "DASHBOARD_REQUIRE_AUTH est désactivé, quiconque atteint cette "
            "page peut créer un compte : garde le dashboard en loopback, ou "
    ...
    ConfigItem(
        ...
        description=(
            ...
            "dashboard » est coché — pour /dashboard/. Le mot de passe passe "
        ...
        record=ConfigRecord(
            ...
            fields=(
                ...
                record_item(key="is_staff",     type="bool",   label="Accès dashboard", default=False,
                            hint="Requis pour /dashboard/ quand DASHBOARD_REQUIRE_AUTH est actif."),
